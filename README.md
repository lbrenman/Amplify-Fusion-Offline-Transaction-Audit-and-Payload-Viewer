...
A web app to view Amplify Fusion [transaction data](https://github.com/lbrenman/amplify-fusion-transactions) retrieved from a fusion dataplane efs. Useful for support teams aiding in debugging integrations.
